        ...
        <div className="xl:ml-[39%] border-l border-r border-gray-200 xl:min-w-[576px] sm:ml-[73px] flex-grow max-w-xl">
          ...
          <div className='flex mt-2 items-center font-bold border-b-2'>
            <img
              ...
              alt="Profile Image"
            />
            <h2>AMIR DARIUS ESTRELLA</h2>
          </div>
          {/* Message Content */}
          <div className=''>
            <div className='ml-10 mt-2'>
              <p className='inline-block bg-gray-400 text-white px-4 py-1 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50'>Otw</p>
              <p className='text-sm text-gray-500 ml-4'>- 15 minutes ago</p>
            </div>
            <div className='ml-80 mr-7 mt-2'>
              <p className='inline-block bg-gray-400 text-white px-4 py-1 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50'>Gege di padung papud ko office</p>
              <p className='text-sm text-gray-500 ml-4'>- 10 minutes ago</p>
            </div>
            <div className='ml-10 mt-2'>
              <p className='inline-block bg-gray-400 text-white px-4 py-1 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50'>dugaya motor jud</p>
              <p className='text-sm text-gray-500 ml-4'>- 8 minutes ago</p>
            </div>
            <div className='ml-80 mr-5 mt-2'>
              <p className='inline-block bg-gray-400 text-white px-4 py-1 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50'>Hahahaha ipagamba igna driver</p>
              <p className='text-sm text-gray-500 ml-4'>- 4 minutes ago</p>
            </div>
            <div className='ml-10 mt-2'>
              <p className='inline-block bg-gray-400 text-white px-4 py-1 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50'>HAHAHAHAHAHA</p>
