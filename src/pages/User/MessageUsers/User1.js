  ...
  return (
    <div>
        ...
        <div className="justify-between flex py-2 px-3 sticky top-0 z-50 bg-white border-b border-gray-200 items-center">
            ...
            <div className='ml-10 mt-2'>
                <p className='inline-block bg-gray-400 text-white px-4 py-1 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50'>Gege naarami office naghuwat</p>
