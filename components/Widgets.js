...
//                 <div key={randomUser.login.username} className="flex items-center px-4 py-2 cursor-pointer hover:bg-gray-200 border border-gray-20 transition duration-500 ease-out " >
