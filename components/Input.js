             ...
             <div className="flex items-center justify-between pt-2.5">
              {!loading && (
                ...
                <div className="flex ">
                 ...
                 <button onClick={sendPost} disabled={!input.trim()} className="bg-blue-400 text-white px-4 py-1.5 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50 ">Post</button>
                </>
              )}
